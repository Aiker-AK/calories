...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"„тобы вы€снить точную цифру нужно \r\nвоспользоватьс€ формулой ’арриса-Ѕенедикта:\r\n"
				L"";
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Font = (gcnew System::Drawing::Font(L"Times New Roman", 14.25F, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Underline)),
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
			this->label2->Location = System::Drawing::Point(3, 53);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(110, 22);
			this->label2->TabIndex = 1;
			this->label2->Text = L"∆енщины: \r\n";
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Font = (gcnew System::Drawing::Font(L"Times New Roman", 14.25F, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Underline)),
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(204)));
			this->label3->Location = System::Drawing::Point(3, 97);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(103, 22);
			this->label3->TabIndex = 2;
			this->label3->Text = L"ћужчины:";
			// 
			// label4
			// 
			...
			this->label4->Size = System::Drawing::Size(403, 22);
			this->label4->TabIndex = 3;
			this->label4->Text = L"9,99 * вес + 6,25 * рост  Ц 4,92 * возраст Ц 161";
			// 
			// label5
			// 
			...
			this->label5->Size = System::Drawing::Size(379, 22);
			this->label5->TabIndex = 4;
			this->label5->Text = L"9,99 * вес + 6,25 * рост  Ц 4,92 * возраст +5";
			// 
			// label6
			// 
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Tahoma", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label6->Location = System::Drawing::Point(2, 162);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(459, 184);
			...
			this->MaximumSize = System::Drawing::Size(477, 405);
			this->MinimumSize = System::Drawing::Size(477, 405);
			this->Name = L"MyForm1";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"ќб программе";
